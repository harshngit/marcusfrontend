...
export default function VideoSection() {
  ...
  const yBottom = useTransform(scrollYProgress, [0, 1], [0, 120]);
  ...
  return (
    <AnimatedSection as="section" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div ref={sectionRef} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          aria-hidden
          className="pointer-events-none absolute -top-28 -left-16 w-[28rem] h-[28rem] rounded-full bg-blue-500/10 dark:bg-cyan-500/10 blur-3xl"
          style={{ y: yTop }}
        />
        <motion.div
          aria-hidden
          className="pointer-events-none absolute -bottom-32 -right-10 w-[26rem] h-[26rem] rounded-full bg-cyan-500/10 dark:bg-blue-500/10 blur-3xl"
          style={{ y: yBottom }}
        />
